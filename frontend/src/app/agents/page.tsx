...
import { Bot, Plus, RefreshCw, Terminal, ShieldCheck, Zap } from "lucide-react";
...
export default function AgentsPage() {
  const { data, isLoading, isError, refetch, isFetching } = useAgentsData();
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 rounded-xl p-4 flex items-center justify-between shadow-sm">
          <div>
            ...
            <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">18,500+</p>
          </div>
      ...
      {/* Main Grid: Agents List + Reasoning Trace Inspector */}
