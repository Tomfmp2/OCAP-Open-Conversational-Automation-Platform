...
using OCAP.Channels.WebChat.Extensions;
...
// Registra la arquitectura de canales y los canales nativos (WhatsApp, Telegram, WebChat).
...
builder.Services.AddWebChatChannel(builder.Configuration);
