...
namespace OCAP.Channels.Abstractions.Services;

// Servicio empresarial para la gestión en tiempo de ejecución de las conexiones de canales por Tenant.
public class ChannelConnectionManager : IChannelConnectionManager
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Validar que el proveedor esté registrado en el catálogo global
        ...
        // Verificar unicidad de conexión por Tenant + Proveedor
        ...
        // Almacenar las credenciales de forma cifrada en el Vault
