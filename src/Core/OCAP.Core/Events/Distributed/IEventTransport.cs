...
// Contrato agnóstico para transportes del bus de eventos (RabbitMQ, NATS, InMemory).
public interface IEventTransport
{
    ...
    Task PublishRawAsync(RawEventMessage message, CancellationToken cancellationToken = default);
    Task PublishBatchAsync(IReadOnlyList<RawEventMessage> messages, CancellationToken cancellationToken = default);
